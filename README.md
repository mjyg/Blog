...
* 其他
  ...
  * [请求失败后一定时间重试](./src/other/request.js)
  * [字符串解析](./src/other/analysis-str.js) 
  * [CSS实现左侧宽度固定，右侧自适应布局](./src/other/css-layout.css) 
  * [CSS实现左右侧宽度固定，中间自适应布局](./src/other/css-layout2.css) 
  * [判断一个对象是数组的不同方式](./src/other/isArray.js) 
  * [检测循环依赖](./src/other/isCircle.js) 
  * [input输入格式化，并调整光标位置](./src/other/formatInput.html) 
* [笔记](./src/note/note.md)
